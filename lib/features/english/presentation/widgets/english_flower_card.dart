...
/// English flower card with pre-recorded audio only (no TTS).
/// Used by: EnglishFlowerScreen
class EnglishFlowerCard extends StatefulWidget {
  ...
  @override
  State<EnglishFlowerCard> createState() => _EnglishFlowerCardState();
}

class _EnglishFlowerCardState extends State<EnglishFlowerCard> {
  String get _itemId => 'flower_${widget.item.id}';
