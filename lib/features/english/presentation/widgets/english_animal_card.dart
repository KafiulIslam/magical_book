...
/// English animal card with pre-recorded audio only (no TTS).
/// Used by: EnglishAnimalScreen
class EnglishAnimalCard extends StatefulWidget {
  ...
  @override
  State<EnglishAnimalCard> createState() => _EnglishAnimalCardState();
}

class _EnglishAnimalCardState extends State<EnglishAnimalCard> {
  String get _itemId => 'animal_${widget.item.id}';
