...
class BanglaDayScreen extends StatefulWidget {
  const BanglaDayScreen({super.key});

  @override
  State<BanglaDayScreen> createState() => _BanglaDayScreenState();
}

class _BanglaDayScreenState extends State<BanglaDayScreen> {
